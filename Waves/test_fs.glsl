...
// surface reflectance
vec3 Ks = vec3 (0.0, 0.0, 0.3); // fully reflect specular light
vec3 Kd = vec3 (0.0, 0.2, 1.0); // orange diffuse surface reflectance
vec3 Ka = vec3 (0.0, 0.0, 0.1); // fully reflect ambient light
